...
public class ReplyGiftDialog extends DialogUtils {
    EditText editText;
    TextView text1;
    TextView text2;
    TextView text3;
    ...
    TextView text5;
    TextView text6;
    private DyConfig.DyReplyGift data;
    private DialogCallback callback;
    private List<String> cloneGift;

    public ReplyGiftDialog(@NonNull Context context) {
        super(context);
    ...
    public DialogUtils setData(final DyConfig.DyReplyGift data, DialogCallback callback) {
    ...
    @Override
    int getLayoutId() {
        return R.layout.dialog_reply_gift_view;
    }
}
